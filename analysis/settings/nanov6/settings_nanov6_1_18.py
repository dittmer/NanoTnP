...
flags = {
    ...
    'passingMVA94Xwp90isoHWWiso0p06SS'    : '({0}) && ({1}) && ({2}) && ({3}) && (Probe_cutBased_Fall17_V1>=3) && (Probe_mvaFall17V1Iso_WP90==1) && (Probe_3charge==1)'.format(cutDxy,cutDz,cutLoose,cutIso),
...
baseOutDir = '%s/results/Legacy2018/nanov6/tnpEleID' %os.getcwd()
...
samplesDef = {
    'data'   : tnpSamples.nanov6_1_18['data_Run2018'].clone(),
    'mcNom'  : tnpSamples.nanov6_1_18['DYJetsToLL_M-50-LO'].clone(),
    'mcAlt'  : tnpSamples.nanov6_1_18['DYJetsToLL_M-50'].clone(),
    'tagSel' : tnpSamples.nanov6_1_18['DYJetsToLL_M-50-LO'].clone(),
}
...
if not samplesDef['tagSel'] is None:
    ...
    samplesDef['tagSel'].set_cut('Tag_pt > 42') #canceled non trig MVA cut
...
#############################################################
### cut
cutBase   = 'Tag_pt > 37 && Tag_charge*Probe_charge < 0'
