...
baseOutDir = '%s/analysis/results/nanoUL_16H_noHIPM/tnpEleID' %os.environ.get('BASETNP')
...
samplesDef = {
    'data'   : tnpSamples.nanoUL_16_noHIPM['data_Run2016H_noHIPM'].clone(),
...
tnpParAltSigFit = [
    ...
    "meanF[-0.0,-10.0,5.0]","sigmaF[2,0.7,15.0]","alphaF[2.0,1.2,3.5]",'nF[3,-5,5]',"sigmaF_2[2.0,0.5,6.0]","sosF[1,0.5,8.0]",
