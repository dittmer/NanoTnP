...
baseOutDir = '%s/analysis/results/nanoUL_17E/tnpEleID' %os.environ.get('BASETNP')
...
samplesDef = {
    'data'   : tnpSamples.nanoUL_17['data_Run2017E'].clone(),
...
tnpParAltBkgFit = [
    "meanP[-0.0,-5.0,5.0]","sigmaP[0.9,0.5,5.0]",
    "meanF[-0.0,-5.0,5.0]","sigmaF[1.6,0.5,5.0]",
    "alphaP[0.,-5.,5.]",
    "alphaF[-0.035,-5.,5.]",
    ]
