...
baseOutDir = '%s/analysis/results/nanoUL_18_ttHcheck/tnpEleID' %os.environ.get('BASETNP')
...
#############################################################
### cut
cutBase   = 'Tag_charge*Probe_charge < 0 && ({0}) && ({1}) && ({2}) && ({3}) && (Probe_mvaFall17V2Iso_WP90==1)'.format(cutDxy,cutDz,cutLoose,cutIso)
