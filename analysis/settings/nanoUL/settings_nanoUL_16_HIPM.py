...
flags = {
    ...
    'passingHWWMVA'      : '({0}) && ({1}) && ({2}) && ({3}) && (Probe_mva>0.824)'.format(cutDxy,cutDz,cutLoose,cutIso)
}

baseOutDir = '%s/analysis/results/nanoUL_16_HIPM/tnpEleID' %os.environ.get('BASETNP')
...
samplesDef = {
    'data'   : tnpSamples.nanoUL_16_HIPM['data_Run2016_HIPM'].clone(),
    'mcNom'  : tnpSamples.nanoUL_16_HIPM['DYJetsToLL_M-50-LO'].clone(),
    'mcAlt'  : tnpSamples.nanoUL_16_HIPM['DYJetsToLL_M-50'].clone(),
    'tagSel' : tnpSamples.nanoUL_16_HIPM['DYJetsToLL_M-50-LO'].clone(),
}
...
if not samplesDef['tagSel'] is None:
    ...
    samplesDef['tagSel'].set_cut('Tag_pt > 32') #nominal 29
...
tnpParAltSigFit = [
    "meanP[-0.0,-5.0,5.0]","sigmaP[1,0.7,6.0]","alphaP[2.0,1.2,3.5]" ,'nP[3,-5,5]',"sigmaP_2[2.0,0.5,6.0]","sosP[1,0.5,5.0]",
    #"meanF[-0.0,-5.0,5.0]","sigmaF[2,0.7,15.0]","alphaF[2.0,1.2,3.5]",'nF[3,-5,5]',"sigmaF_2[2.0,0.5,6.0]","sosF[1,0.5,5.0]",
    "meanF[-0.0,-10.0,5.0]","sigmaF[2,0.7,15.0]","alphaF[2.0,1.2,3.5]",'nF[3,-5,5]',"sigmaF_2[2.0,0.5,6.0]","sosF[1,0.5,6.0]",
