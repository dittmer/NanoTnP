...
common = '( abs(probe_sc_eta) < 2.5 && Probe_cutBased_Fall17_V1 >= 3 && Probe_mvaFall17V1Iso_WP90 == 1 && Probe_convVeto == 1 )'
barral = '( ( abs(probe_sc_eta) <= 1.497 ) && ( abs(Probe_dxy) < 0.05 ) && ( abs(Probe_dz) < 0.1 ) )'
endcap = '( ( abs(probe_sc_eta) > 1.497 ) && ( Probe_sieie < 0.03 ) && ( Probe_eInvMinusPInv < 0.014 ) && ( abs(Probe_dxy) < 0.1 ) && ( abs(Probe_dz) < 0.2 ) )'
cutIso = '( Probe_pfRelIso03_all < 0.06 )'
...
#############################################################
### cut
cutBase   = 'Tag_pt > 35 && abs(tag_sc_eta) < 2.17 && Tag_charge*Probe_charge < 0'
