...
samplesDef = {
    ...
    'mcAlt'  : tnpSamples.nanov6_18['DYJetsToLL_M-50_ext2'].clone(),
...
#############################################################
### cut
cutBase   = 'tag_Ele_pt > 35 && abs(tag_Ele_eta) < 2.17 && tag_Ele_q*probe_Ele_q < 0 && passingprobeEleTightHWW==1 && passingtagEleTightHWW==1'
