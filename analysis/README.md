...
>   python tnpEGM_fitter.py settings_17.py  --flag passingHWW_WP --checkBins
...
>   python tnpEGM_fitter.py settings_17.py  --flag passingHWW_WP --createBins
...
>   python tnpEGM_fitter.py settings_17.py --flag passingHWW_WP --createHists

**3. Do your first round of fits.**
   * nominal fit
   
>   python tnpEGM_fitter.py settings_17.py --flag passingHWW_WP --doFit
   
   * MC fit to constrain alternate signal parameters [note this is the only MC fit that makes sense]
   
>   python tnpEGM_fitter.py settings_17.py --flag passingHWW_WP --doFit --mcSig --altSig

   * Alternate signal fit (using constraints from previous fits)
   
>   python tnpEGM_fitter.py settings_17.py --flag passingHWW_WP --doFit  --altSig

   * Alternate background fit (using constraints from previous fits)
   
>   python tnpEGM_fitter.py settings_17.py --flag passingHWW_WP --doFit  --altBkg
...
>   python tnpEGM_fitter.py settings_17.py --flag passingHWW_WP --doFit --iBin ib
...
>   python tnpEGM_fitter.py settings_17.py --flag passingHWW_WP --doFit --mcSig --altSig --iBin ib
